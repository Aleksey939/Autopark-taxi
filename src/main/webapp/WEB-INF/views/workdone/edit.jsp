        ...
        <div class="col-md-4 col-lg-4 content-container">
            <div class="field">
                <form id="work" method="post">
                    ...
                    <br/>
                    <label>Наименование: <input value="${workDone.get().name}"  name="name"/>
                    </label>
                    <br/>
                    <label>Описание: <textarea   form="work" name="description" >${workDone.get().description}</textarea>
                    </label>
                    <br/>
                    <label>Стоимость: <input value="${workDone.get().price}"  name="price"/>
                    </label>
                    <br/>
